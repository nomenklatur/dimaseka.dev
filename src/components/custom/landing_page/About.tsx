...
const About = () => {
  ...
  return (
    <section id="about" className="mt-24 min-h-screen px-8">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          {/* Profile Image */}
          <div className="flex-shrink-0">
            <div className="w-80 h-80 rounded-full bg-muted overflow-hidden">
              <Image 
                src="/images/me.jpg"
                alt="Dimas Eka Putra"
                width={320}
          ...
          <div className="flex-1 text-left">
            <h2 className="text-3xl lg:text-7xl font-bold mb-8 leading-tight">
              Full Stack
              <br />
              Software Engineer
            </h2>
            
            <div className="space-y-6 text-lg text-muted-foreground max-w-2xl mb-8">
              <p>
                Currently building scalable web applications and leading development 
                teams to create innovative digital solutions for businesses worldwide.
              </p>
