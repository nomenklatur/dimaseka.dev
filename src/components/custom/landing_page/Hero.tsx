        ...
        <>
            <div className='w-screen h-screen flex flex-col justify-center items-center snap-start'>
                ...
                <div className="mt-6 md:mt-8 flex flex-col md:flex-row gap-2 items-center">
                    ...
                    <a href="https://calendar.app.google/QWh7tRdk9x2pkDHo8" target="_blank" className="cursor-pointer text-gray-800 px-3 py-1 md:px-2 md:py-1 lg:px-4 lg:py-2 rounded-md text-sm shadow-lg border border-gray-800">Schedule a call</a>
                </div>
            </div>
        </>
    )
